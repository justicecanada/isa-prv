...
namespace Interview.UI.Models.CustomValidation
{
    ...
    public class CompareDateTimes : ValidationAttribute
    {
        ...
        public CompareDateTimes(string compareOperator, string propertyName, string conditionalPropertyName = null)
        {
