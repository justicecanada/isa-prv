...
namespace Interview.UI.Models.CustomValidation
{
    ...
    public class CompareDateTimeOffsets : ValidationAttribute
    {
        ...
        public CompareDateTimeOffsets(string compareOperator, string propertyName, string conditionalPropertyName = null)
        {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext context)
        {
            ...
            if ((dependentValue != null) && (value != null) && conditionalValue)
            {
                ...
                DateTimeOffset dependentDate = DateTimeOffset.Parse(dependentValue.ToString());
