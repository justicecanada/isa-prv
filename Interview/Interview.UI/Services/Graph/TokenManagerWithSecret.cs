...
namespace Interview.UI.Services.Graph
{
    ...
    public class TokenManagerWithSecret : IToken
    {
        ...
        public TokenManagerWithSecret(HttpClient client, IConfiguration config, IOptions<TokenOptions> tokenOptions, ILogger<TokenManagerWithSecret> logger,
            IMemoryCache cache)
        {
